...
@section('content')
    <div class="box">
        ...
        <div class="box-header">
            <h3 class="box-title">Drivers Data</h3>
        </div>

        <div class="box-header">
            <a onclick="addForm()" class="btn btn-primary" >Add Drivers</a>
